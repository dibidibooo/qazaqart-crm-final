  ...
  <AuthLayout>
    <b-col xl="12">
          ...
          <b-row class="align-items-center g-0">
            ...
            <b-col lg="6">
              <div class="p-4">
                ...
                <h2 class="fw-bold text-center fs-18">Привет ! Пользователь</h2>
                <p class="text-muted text-center mt-1 mb-4">Введите пароль для доступа.</p>

                <b-row class="justify-content-center">
                  <b-col md="8" cols="12">
                    <b-form class="authentication-form">
                      <b-form-group class="mb-3">
                        <b-form-input type="password" id="example-password" name="password" placeholder="Введите свой пароль" />
                      </b-form-group>
      ...
      <p class="text-white mb-0 text-center">
        Это не Вы?
        <router-link :to="{ name: 'auth.sign-in' }" class="text-white fw-bold ms-1">Войти</router-link>
      </p>
    </b-col>
  </AuthLayout>
</template>
