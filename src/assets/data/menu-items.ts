...
export const MENU_ITEMS: MenuItemType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'shop-order',
        label: 'Заказы с магазина',
        route: { name: 'ecommerce.shop-order' },
        parentKey: 'pages'
      },
    ]
  },
  ...
  },
  {
    ...
    label: 'Оплата за мерч',
    route: { name: 'ecommerce.customers' }
  },
  {
    key: 'apps-todo',
    icon: 'iconamoon:ticket-duotone',
